...
//    glfwWindowHint(GL_MULTISAMPLE, 4); // 对默认窗口设置多重采样，所有缓冲增加4倍，使用自定义msaa帧缓冲时取消
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "buddy_parallax_mapping", NULL, NULL);
    if (window == NULL)
    {
    ...
    // -------------------------
    Shader parallaxMappingShader("shader/parallax_mapping.vs", "shader/parallax_mapping.fs");
    ...
    // 加载纹理
    // -------------------------
    unsigned int diffuseTexture = loadTexture("texture/bricks2.jpg");
    unsigned int normalMap = loadTexture("texture/bricks2_normal.jpg");
    unsigned int depthMap = loadTexture("texture/bricks2_disp.jpg");
...
//        model = glm::rotate(model, glm::radians((float)glfwGetTime() * -10.0f), glm::normalize(glm::vec3(1.0, 0.0, 1.0)));
        ...
        parallaxMappingShader.setFloat("height_scale", heightScale);
