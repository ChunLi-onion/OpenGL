...
int main(){
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Buddy_multipleLights", NULL, NULL);
    if (window == NULL)
    {
...
//        model = glm::rotate(model, 0.8f * (float)glfwGetTime(), glm::vec3(1.0f, 2.0f, 0.3f));
        ...
        // directional light
                ...
                lightShader.setVec3("pointLights[0].diffuse", 0.6f, 0.6f, 0.6f);
                ...
                lightShader.setVec3("pointLights[1].diffuse", 0.6f, 0.6f, 0.6f);
                ...
                lightShader.setVec3("pointLights[2].diffuse", 0.6f, 0.6f, 0.6f);
                ...
                lightShader.setVec3("pointLights[3].diffuse", 0.6f, 0.6f, 0.6f);
                ...
                lightShader.setFloat("spotLight.linear", 0.014);
                lightShader.setFloat("spotLight.quadratic", 0.0007);
